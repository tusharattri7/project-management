...
const registerUser = asyncHandler(async (req, res) => {
  // Explicitly extract only allowed registration fields
  ...
  // Handle email sending failure safely
  ...
  try {
    ...
    // Optional: Delete user record so they can retry registration
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
  // only when user logged in already
